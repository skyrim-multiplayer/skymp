...
export declare function writeLogs(
  pluginName: string,
  ...arguments: unknown[]
): void;
...
export declare function findConsoleCommand(
  cmdName: string,
): ConsoleCommand | null;
...
export declare function setTextPos(
  textId: number,
  xPos: number,
  yPos: number,
): void;
...
export declare function setInventory(
  formId: number,
  inventory: Inventory,
): void;
...
export declare class Actor extends ObjectReference {
  ...
  hasAssociation(
    akAssociation: AssociationType | null,
    akOther: Actor | null,
  ): boolean;
...
export declare class Debug extends PapyrusObject {
  ...
  static sendAnimationEvent(
    param1: ObjectReference | null,
    param2: string,
  ): void;
...
export declare class ShaderParticleGeometry extends Form {
  static from(
    papyrusObject: PapyrusObject | null,
  ): ShaderParticleGeometry | null;
  apply(param1: number): void;
...
export declare class Utility extends PapyrusObject {
  ...
  static resizeBoolArray(
    source: boolean[] | null,
    size: number,
    fill: boolean,
  ): boolean[] | null;
  static resizeFloatArray(
    source: number[] | null,
    size: number,
    fill: number,
  ): number[] | null;
  ...
  static resizeIntArray(
    source: number[] | null,
    size: number,
    fill: number,
  ): number[] | null;
  static resizeStringArray(
    source: string[] | null,
    size: number,
    fill: string,
  ): string[] | null;
