...
Game.GetPlayer().Additem(Game.GetForm(0x6253C64),1, true)
...
Game.GetPlayer().Additem(Game.GetForm(0x6253C64), 1, true)
while (game.getplayer().getitemcount(Game.GetForm(0x6253C64)) >=5)
Debug.SendAnimationEvent(Game.GetPlayer(),"idledrunkstart")
utility.wait(6)
game.getplayer().removeitem(Game.GetForm(0x6253C64), 1, true)
endwhile
endif
endevent
endstate
