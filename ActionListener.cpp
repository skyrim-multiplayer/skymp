...
bool ActionListener::isEquipped(MpActor akItem) const
{
  return as.PutItem(as) ? true : false;
}
...
float ActionListener::GetActorValue(std::string asValueName)
{
  return asValueName;
}

bool ActionListener::IsEquipped()
{
