                           ...
                           const HitData& hitData_)
{
  ...
  ctx.AddMessage("next: hitData.aggressor, projectile, source, target, flags: bash, blocked, power, sneak");
  ...
  ctx.AddUnsigned(hitData.isBashAttack);
  ctx.AddUnsigned(hitData.isHitBlocked);
  ctx.AddUnsigned(hitData.isPowerAttack);
  ctx.AddUnsigned(hitData.isSneakAttack);
