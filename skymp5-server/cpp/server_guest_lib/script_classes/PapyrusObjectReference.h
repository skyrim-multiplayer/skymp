...
public:
  ...
  VarValue GetAllItemsCount(VarValue self, const std::vector<VarValue>& arguments);
  
  VarValue IsContainerEmpty(VarValue self, const std::vector<VarValue>& arguments);
