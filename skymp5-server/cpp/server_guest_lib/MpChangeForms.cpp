                                    ...
                                    const std::vector<std::string>& espmFiles)
{
  ...
  res["inv"] =
    changeForm.inv.ToJson(Inventory::ToJsonMode::UseFormDescs, espmFiles);
...
MpChangeForm MpChangeForm::JsonToChangeForm(
  simdjson::dom::element& element, const std::vector<std::string>& espmFiles)
{
  ...
  res.inv =
    Inventory::FromJson(jTmp, Inventory::ToJsonMode::UseFormDescs, espmFiles);
