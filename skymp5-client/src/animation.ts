...
import { ObjectReference, Debug, hooks, Actor, printConsole, Utility, Game } from 'skyrimPlatform'
...
export const applyAnimation = (refr: ObjectReference, anim: Animation, state: AnimationApplyState): void => {
...
const ignoredAnims = new Set<string>(['moveStart', 'moveStop', 'turnStop', 'CyclicCrossBlend', 'CyclicFreeze', 'TurnLeft', 'TurnRight'])
