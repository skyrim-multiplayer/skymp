...
export class LoginResponseAuthData {
  public constructor(public token: string, public id: number, public name: string) {}
}

export class RemoteAuthGameData {
  public constructor(public session: string, public email: string, public rememberMe: boolean) {}
}
