...
const namesEqual = (a: Entry, b: Entry): boolean => {
  ...
  if (a.baseId === b.baseId) {
    ...
    if (form) {
      ...
      if (checkIfNameIsGeneratedByGame(aStr, bStr, formName) || checkIfNameIsGeneratedByGame(bStr, aStr, formName)) return true
    }
  }
...
const extractExtraData = (refr: ObjectReference, extraList: BaseExtraList | null, out: Entry): void => {
