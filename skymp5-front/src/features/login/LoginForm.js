    ...
    <div className={'login-form--content_main'}>
      ...
      <div className={'login-form--content_main__footer'}>
        <div className={'login-form--content_main__label login-form--content_main__container'}>
          <SkyrimHint text={props.locale.LOGIN.REMEMBER_HINT} isOpened={isRememberHintOpened} left={true} />
        ...
        >
          ...
          <SkyrimHint text={props.locale.LOGIN.REGISTER_HINT} isOpened={isRegisterHintOpened} left={false} />
        </div>
      </div>
