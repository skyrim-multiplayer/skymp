...
const Button = (props) => {
  ...
  switch (css) {
    ...
    case 'BUTTON_STYLE_PATREON':
      return (
        <ImageButton disabled={disabled} src={require('../../img/patreon.svg').default} onClick={onClick} width={width} height={height} />
      )
    case 'BUTTON_STYLE_GITHUB':
      return (
        <ImageButton disabled={disabled} src={require('../../img/github.svg').default} onClick={onClick} width={width} height={height} />
      )
    default:
