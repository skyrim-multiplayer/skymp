  ...
  return (
    <div className='chat-settings'>
      <div className='content'>
        ...
        <CheckBox text={'Sounds'} initialValue={!props.isSoundsDisabled} setChecked={(value) => props.setDisableSounds(!value)} disabled={false} />
        <CheckBox text={'Send Button'} initialValue={props.showSendButton} setChecked={props.setShowSendButton} disabled={false} />
      </div>
